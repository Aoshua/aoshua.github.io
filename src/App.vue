<script setup lang="ts">
	...
	const territorioImages = [{ src: "/img/products/run-io.png", alt: "Territorio app showing a live run on a map" }]
</script>
...
<template>
	<div class="relative min-h-screen overflow-x-hidden bg-neutral-50 text-neutral-900">
		...
		<div class="relative mx-auto max-w-4xl px-4 sm:px-6">
			...
			<main class="space-y-16 pb-16 sm:space-y-20">
				...
				<section aria-labelledby="apps-heading">
					...
					<div class="mt-6 space-y-8">
						<!-- Territorio — future app cards slot in below this one -->
						<article class="grid grid-cols-1 items-center gap-8 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-black/5 sm:p-8 md:grid-cols-2">
							...
							<div class="text-center md:text-left">
								<h3 class="font-display text-3xl sm:text-4xl">Territorio</h3>
								<p class="mt-2 text-lg font-medium text-brand-600">Run. Claim your streets. Compete with friends.</p>
								<p class="mt-3 text-neutral-600">
									Territorio turns every run into a game of conquest — trace routes through your neighborhood to capture territory on a live map and defend it
									from other runners.
								</p>
								...
								<div class="mt-6 flex flex-wrap justify-center gap-3 md:justify-start">
									<a href="#" class="inline-flex items-center gap-2.5 rounded-xl bg-neutral-900 px-4 py-2.5 text-white transition hover:bg-neutral-700">
										...
										<span class="text-left leading-tight"
											><span class="block text-[0.65rem] text-neutral-300">Download on the</span
				...
				<section aria-labelledby="privacy-heading">
					...
					<h2 id="privacy-heading" class="mt-1 text-2xl font-semibold sm:text-3xl">Privacy Policy</h2>
					<!-- TODO: replace with final privacy policy text from Josh -->
					<p class="mt-4 max-w-3xl text-lg leading-relaxed text-neutral-600">
						Forsyte Studios apps do not collect, store, or share personal information. If you have any questions about this policy, contact us at the email address
						below.
					</p>
				</section>
			...
			<footer class="border-t border-neutral-200 py-8 text-center text-sm text-neutral-400">© 2026 Forsyte Studios</footer>
		</div>
	</div>
</template>
